...
export default function ExclusiveIMGPerksPage() {
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="min-h-[50vh] bg-gradient-to-br from-[#3A3C51] to-[#292733] flex items-center py-24 px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <p className="text-[#A9D6B6] text-sm font-semibold uppercase tracking-widest mb-4">International Marketing Group</p>
            <h1 className="text-4xl md:text-6xl font-bold font-[family-name:var(--font-playfair)] leading-tight mb-6">
              Exclusive IMG Perks
            </h1>
            <p className="text-xl text-[#D5A0F4] font-[family-name:var(--font-playfair)] italic mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://1204jf.imgcorp.com/" target="_blank" rel="noopener noreferrer"
                className="bg-[#A9D6B6] text-[#3A3C51] font-semibold px-8 py-3 rounded-full hover:bg-white hover:text-[#3A3C51] transition-all">
                Be an IMG Member
              </a>
              <a href="https://1204jf.imgcorp.com/buildingyourfuture/register.html" target="_blank" rel="noopener noreferrer"
                className="border-2 border-white text-white font-semibold px-8 py-3 rounded-full hover:bg-white hover:text-[#3A3C51] transition-all">
                Attend Webinar
              </a>
            </div>
          </div>
        ...
        <section className="bg-[#F8F8F8] py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-[#A9D6B6] text-sm font-semibold uppercase tracking-widest mb-2">Start Here</p>
            ...
            <p className="text-[#474747] leading-relaxed mb-6 text-lg">
            ...
            <a href="https://1204jf.imgcorp.com/" target="_blank" rel="noopener noreferrer"
              className="bg-[#D7C4E3] text-[#3A3C51] font-semibold px-8 py-3 rounded-full hover:bg-[#3A3C51] hover:text-white transition-all inline-block">
        ...
        <section className="bg-white py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-[#A9D6B6] text-sm font-semibold uppercase tracking-widest mb-2">Member Benefits</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              {[
                ...
                <div key={card.title} className="bg-white rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all p-8 border-t-4 border-t-[#D5A0F4]">
            ...
            <div className="text-center">
              <p className="text-xl italic text-[#D5A0F4] max-w-3xl mx-auto">
                &ldquo;Every benefit we offer at IMG is built on a foundation of EMPOWERMENT—designed to help you rise financially, personally, and professionally.&rdquo;
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#3A3C51] py-20 px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <p className="text-[#A9D6B6] text-sm font-semibold uppercase tracking-widest mb-2">Featured Program</p>
            <h2 className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-playfair)] mb-4">
              Secure Your Future with Kaiser Health Builder
            </h2>
            <p className="text-xl text-[#D5A0F4] font-[family-name:var(--font-playfair)] italic mb-8">
            ...
            <a href="https://img.com.ph/quote/UKHB/?agentcode=1204jf" target="_blank" rel="noopener noreferrer"
              className="bg-[#A9D6B6] text-[#3A3C51] font-semibold px-8 py-3 rounded-full hover:bg-white hover:text-[#3A3C51] transition-all inline-block">
